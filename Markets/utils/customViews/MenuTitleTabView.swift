...
protocol MenuTitleBarDelegate {
    func menubarDidSelectItemAt(menu: MenuTitleTabView, index:Int)
}


class MenuTitleTabView: UIView, UICollectionViewDelegate, UICollectionViewDataSource,
    ...
    var menuDelegate:MenuTitleBarDelegate?
    ...
    private func customInitializer() {
        collectionView.register(UINib(nibName: "TitleTabCell", bundle: nil), forCellWithReuseIdentifier: TitleTabCell.identifier)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if let cell = collectionView.dequeueReusableCell(withReuseIdentifier: TitleTabCell.identifier, for: indexPath) as? TitleTabCell {
