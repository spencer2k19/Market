...
class WalletViewController: UIViewController {
    ...
    var tabsPage: [WalletPagerViewController] = []
...
extension WalletViewController: UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    func pageViewController(_ pageViewController: UIPageViewController, viewControllerBefore viewController: UIViewController) -> UIViewController? {
        ...
        var index = (viewController as! WalletPagerViewController).pageIndex
    ...
    func pageViewController(_ pageViewController: UIPageViewController, didFinishAnimating finished: Bool, previousViewControllers: [UIViewController], transitionCompleted completed: Bool) {
        ...
        if finished {
            if completed {
                let contentVC = pageViewController.viewControllers!.first as! WalletPagerViewController
